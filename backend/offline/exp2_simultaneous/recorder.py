# recorder.py - Module that records entry EEG data as OpenBCI GUI format 
...
class EEGRecorder:
    ...
    def start(self, label="sesion"):
        ...
        # Opens a new file and starts writing the header as OpenBCI GUI style
        ...
        print(f"[Recorder] Recording at: {filename}")
        return filename

    def stop(self):
        
        # Closes the file and ends the recording session
        ...
        print(f"[Recorder] File saved at: {self.current_filename}")
    ...
    def write_chunk(self, eeg_uv, timestamps, accel=None):
        ...
        # Samples are writen here when been taken as raw EEG data, without been filtered
    ...
    # Numerical exponential conversion formats as OpenBCI GUi collaborates with Processing
