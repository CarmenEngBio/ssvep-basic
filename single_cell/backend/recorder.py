...
class EEGRecorder:
    # Recorder in .txt format as OpenBCI GUI. 
    ...
    def start(self, label="sesion"):
        # Opens new file and writes the header attempting to mimic OpenBCI GUI format
    ...
    def stop(self):
        # Closes the file when recording ends.
        with self._lock:
